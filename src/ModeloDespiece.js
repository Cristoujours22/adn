...
const DEFAULT_SERVICES = [
  ...
  { nomenclatura: 'RANULED', nombreOriginal: 'RANURA PARA DIFUSOR LED', tipoCobro: 'unidad' },
  { nomenclatura: 'CSCURVA1', nombreOriginal: 'CURVA', tipoCobro: 'unidad' },
  { nomenclatura: 'SRNAR000', nombreOriginal: 'NARIZ, ENGRUESE', tipoCobro: 'ml_largo_ancho' },
  { nomenclatura: 'SRREPEGA', nombreOriginal: 'ENGRUESE COMPLETO O ENSANDUCHAR', tipoCobro: 'ml_largo_ancho' },
  { nomenclatura: 'SERVREME', nombreOriginal: 'ENGRUESE COMPLETO SOLO CON PEGANTE', tipoCobro: 'ml_largo_ancho' },
  ...
  { nomenclatura: 'SRCALAEI', nombreOriginal: 'CALADO CON ENCHAPE INTERNO', tipoCobro: 'escala_60' },
  { nomenclatura: 'SERVIENL', nombreOriginal: 'EN L O ESCRITORIO', tipoCobro: 'unidad' },
  { nomenclatura: 'CSCHAFLA', nombreOriginal: 'CHAFLAN O CORTE A 45º', tipoCobro: 'unidad' },
  { nomenclatura: 'SENCHAMANUAL', nombreOriginal: 'ENCHAPE A PIEZA ESPECIAL', tipoCobro: 'ml_largo_ancho' },
  { nomenclatura: 'SENCHACURVA', nombreOriginal: 'ENCHAPE EN MÁQUINA CURVA', tipoCobro: 'ml_largo_ancho' },
  { nomenclatura: 'CSCANTOC2', nombreOriginal: 'Enchape Canto Curvo 2mm. (Rígido)', tipoCobro: 'ml_largo_ancho' },
  { nomenclatura: 'CSINGLES', nombreOriginal: 'CAJA MEDIA MADERA ESTANTERÍA', tipoCobro: 'unidad' },
